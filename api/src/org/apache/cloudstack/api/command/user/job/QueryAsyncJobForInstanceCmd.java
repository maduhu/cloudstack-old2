...
public class QueryAsyncJobForInstanceCmd extends BaseCmd {
    ...
    @Parameter(name=ApiConstants.INSTANCE, type=CommandType.STRING, required=true, description="the UUID of the instance.")
    ...
    @Override
    public void execute(){
        AsyncJobResponse response = _responseGenerator.queryJobResultForInstance(this);
