                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":IcmpTypeCodeType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "IcmpTypeCodeType",
    ...
    public static class Factory{
        ...
        */
        public static IcmpTypeCodeType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IcmpTypeCodeType object =
                new IcmpTypeCodeType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IcmpTypeCodeType".equals(type)){
                                ...
                                return (IcmpTypeCodeType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
