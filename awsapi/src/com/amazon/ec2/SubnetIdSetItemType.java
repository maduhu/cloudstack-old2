                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubnetIdSetItemType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SubnetIdSetItemType",
    ...
    public static class Factory{
        ...
        */
        public static SubnetIdSetItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubnetIdSetItemType object =
                new SubnetIdSetItemType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubnetIdSetItemType".equals(type)){
                                ...
                                return (SubnetIdSetItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
