 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = PurchaseReservedInstancesOfferingType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PurchaseReservedInstancesOfferingType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                              ...
                              if (localLimitPriceTracker){
                                           ...
                                           localLimitPrice.serialize(new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2014-02-01/","limitPrice"),
                                               factory,xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static PurchaseReservedInstancesOfferingType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PurchaseReservedInstancesOfferingType object =
                new PurchaseReservedInstancesOfferingType();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PurchaseReservedInstancesOfferingType".equals(type)){
                                ...
                                return (PurchaseReservedInstancesOfferingType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ec2.amazonaws.com/doc/2014-02-01/","limitPrice").equals(reader.getName())){
