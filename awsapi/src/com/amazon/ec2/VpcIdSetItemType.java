                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VpcIdSetItemType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VpcIdSetItemType",
    ...
    public static class Factory{
        ...
        */
        public static VpcIdSetItemType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VpcIdSetItemType object =
                new VpcIdSetItemType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VpcIdSetItemType".equals(type)){
                                ...
                                return (VpcIdSetItemType)com.amazon.ec2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
