...
//             param3.setStatus( snap.getState());
	...
	@Override
	public ModifySubnetAttributeResponse modifySubnetAttribute(ModifySubnetAttribute modifySubnetAttribute) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public RejectVpcPeeringConnectionResponse rejectVpcPeeringConnection(RejectVpcPeeringConnection rejectVpcPeeringConnection) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}
	...
	@Override
	public AcceptVpcPeeringConnectionResponse acceptVpcPeeringConnection(AcceptVpcPeeringConnection acceptVpcPeeringConnection) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}
	...
	@Override
	public DeleteVpcPeeringConnectionResponse deleteVpcPeeringConnection(DeleteVpcPeeringConnection deleteVpcPeeringConnection) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public CreateVpcPeeringConnectionResponse createVpcPeeringConnection(CreateVpcPeeringConnection createVpcPeeringConnection) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public DescribeAccountAttributesResponse describeAccountAttributes(DescribeAccountAttributes describeAccountAttributes) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public DescribeVpcAttributeResponse describeVpcAttribute(DescribeVpcAttribute describeVpcAttribute) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public DescribeVpcPeeringConnectionsResponse describeVpcPeeringConnections(DescribeVpcPeeringConnections describeVpcPeeringConnections) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public ModifyReservedInstancesResponse modifyReservedInstances(ModifyReservedInstances modifyReservedInstances) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}

	@Override
	public ModifyVpcAttributeResponse modifyVpcAttribute(ModifyVpcAttribute modifyVpcAttribute) {
        throw new EC2ServiceException(ClientError.Unsupported, "This operation is not available");
	}
}
